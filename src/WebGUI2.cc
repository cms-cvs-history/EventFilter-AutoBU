...
WebGUI2::WebGUI2(xdaq::Application* app, BStateMachinePtr fsm)
  : app_(app)
  , fsm_(fsm)
  ...
  , hyperDAQIcon_("/hyperdaq/images/HyperDAQ.jpg")
{
  ...
  // bind xgi callbacks
  xgi::bind(this,&WebGUI2::defaultWebPage,"defaultWebPage");
  xgi::bind(this,&WebGUI2::debugWebPage,  "debugWebPage");
  xgi::bind(this,&WebGUI2::css,           "styles.css");
...
//______________________________________________________________________________
void WebGUI2::defaultWebPage(Input_t *in,Output_t *out) throw (WebGUI2::XgiException_t)
{
  updateParams();
...
//______________________________________________________________________________
void WebGUI2::debugWebPage(Input_t *in,Output_t *out) throw (WebGUI2::XgiException_t)
{
  updateParams();
...
//______________________________________________________________________________
void WebGUI2::css(Input_t *in,Output_t *out) throw (WebGUI2::XgiException_t)
{
  css_.css(in,out);
}
...
//______________________________________________________________________________
void WebGUI2::addStandardParam(CString_t& name,Param_t* param)
{
...
//______________________________________________________________________________
void WebGUI2::addMonitorParam(CString_t& name,Param_t* param)
{
  if (parametersExported_) {
...
//______________________________________________________________________________
void WebGUI2::addDebugParam(CString_t& name,Param_t* param)
{
  if (parametersExported_) {
...
//______________________________________________________________________________
void WebGUI2::addStandardCounter(CString_t& name,Counter_t* counter)
{
  if (countersAddedToParams_) {
    LOG4CPLUS_ERROR(log_,"can't add standard counter '"<<name
		    <<"' to WebGUI2 of "<<sourceId_);
  }
...
//______________________________________________________________________________
void WebGUI2::addMonitorCounter(CString_t& name,Counter_t* counter)
{
  if (countersAddedToParams_) {
...
//______________________________________________________________________________
void WebGUI2::addDebugCounter(CString_t& name,Counter_t* counter)
{
  if (countersAddedToParams_) {
...
//______________________________________________________________________________
void WebGUI2::addItemChangedListener(CString_t& name,xdata::ActionListener* l)
{
  if (!parametersExported_) {
    LOG4CPLUS_ERROR(log_,"Can't add ItemChangedListener for parameter '"<<name
		    <<"' before WebGUI2::exportParameters() is called.");
    return;
  }
...
//______________________________________________________________________________
void WebGUI2::addParamsToInfoSpace(const ParamVec_t& params,
...
//______________________________________________________________________________
void WebGUI2::addCountersToParams()
{
...
//______________________________________________________________________________
bool WebGUI2::isMonitorParam(CString_t& name)
{
...
//______________________________________________________________________________
void WebGUI2::htmlTable(Input_t*in,Output_t*out,
...
//______________________________________________________________________________
void WebGUI2::htmlHead(Input_t *in,Output_t* out,CString_t& pageTitle)
{
...
//______________________________________________________________________________
void WebGUI2::htmlHeadline(Input_t *in,Output_t *out)
{
  string stateName=fsm_->getCurrentStateName();
